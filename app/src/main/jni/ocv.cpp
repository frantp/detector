...
SETTER_ED (jint,     descriptor_alg, descriptorAlg)

SETTER_ED (jint,     orb_params.num_features, orbNumFeatures)
SETTER_ED (jdouble,  orb_params.scale_factor, orbScaleFactor)
SETTER_ED (jint,     orb_params.num_levels, orbNumLevels)
SETTER_ED (jint,     orb_params.edge_threshold, orbEdgeThreshold)
SETTER_ED (jint,     orb_params.first_level, orbFirstLevel)
SETTER_ED (jint,     orb_params.WTA_K, orbWtaK)
SETTER_ED (jint,     orb_params.score_type, orbScoreType)
SETTER_ED (jint,     orb_params.patch_size, orbPatchSize)
SETTER_ED (jint,     orb_params.fast_threshold, orbFastThreshold)

SETTER_ED (jint,     akaze_params.descriptor_type, akazeDescriptorType)
SETTER_ED (jint,     akaze_params.descriptor_size, akazeDescriptorSize)
SETTER_ED (jint,     akaze_params.descriptor_channels, akazeDescriptorChannels)
SETTER_ED (jdouble,  akaze_params.threshold, akazeThreshold)
SETTER_ED (jint,     akaze_params.nOctaves, akazeNOctaves)
SETTER_ED (jint,     akaze_params.nOctaveLayers, akazeNOctaveLayers)
SETTER_ED (jint,     akaze_params.diffusivity, akazeDiffusivity)
...
SETTER_ED (jint,     pnp_method, pnpMethod)
